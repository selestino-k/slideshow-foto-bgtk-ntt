...
import { updatePhoto, getPhotoById } from "@/lib/actions/photo-actions"
...
export default function EditPhotoPage({ params }: EditPhotoPageProps) {
  ...
  useEffect(() => {
    const fetchPhoto = async () => {
      try {
        const photo = await getPhotoById(resolvedParams.id)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      submitData.append("timelineDate", format(date, "yyyy-MM-dd"))
      ...
      const result = await updatePhoto(submitData)
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="location"
                  placeholder="Masukkan lokasi foto (opsional)"
